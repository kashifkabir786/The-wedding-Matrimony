...
<?php
$query_Recordset2 = "SELECT A.*, B.* FROM subscription AS A INNER JOIN user AS B ON A.user_id = B.user_id";
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> <span class="page-title-icon bg-gradient-primary text-white me-2"> <i
                                    class="mdi mdi-office"></i> </span> Subscription </h3>
                    </div>
                    ...
                    <div class="row">
                      ...
                      if ( $totalRows_Recordset2 > 0 ) {
                          do {
                              ?>
                                                <tr>
                                                    <td><?php echo $row_Recordset2['subscription_id']; ?></td>
                                                    <td><?php echo $row_Recordset2['mname']; ?></td>
                                                    <td><?php echo $row_Recordset2['subscription_type']; ?></td>
                                                    <td><?php echo date('d M Y',strtotime($row_Recordset2['subsdate'])); ?>
                                                    </td>
                                                    <td><?php echo date('d M Y',strtotime($row_Recordset2['subedate'])); ?>
                                                    </td>
                                                    <td><?php echo $row_Recordset2['status']; ?>
                                                    </td>
                                                    <td><?php echo $row_Recordset2['allowedprofiles']; ?></td>
                                                    <!-- <td><a

...
<?php
$query_Recordset2 = "SELECT A.*, B.* FROM payment AS A INNER JOIN user AS B ON A.user_id = B.user_id";
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> <span class="page-title-icon bg-gradient-primary text-white me-2"> <i
                                    class="mdi mdi-office"></i> </span> Payment </h3>
                    </div>
                          ...
                          do {
                              ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo date('d M Y',strtotime($row_Recordset2['paymentdate'])); ?>
                                                    </td>
                                                    <td><?php echo $row_Recordset2['payment_mode']; ?></td>
                                                    <!-- <td><a

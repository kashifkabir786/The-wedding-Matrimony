...
<?php
$query_Recordset2 = "SELECT * FROM admin";
...
<head>
    ...
    <title>Staff | The Wedding Matrimony</title>
    <!-- plugins:css -->
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> <span class="page-title-icon bg-gradient-primary text-white me-2"> <i
                                    class="mdi mdi-office"></i> </span> Staff </h3>
                    </div>
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-2 mb-1"> <a href="add_staff.php">
                                                <button type="button"
                                                    class="btn btn-gradient-primary btn-rounded btn-fw"> &nbsp;ADD <i
                                                        class="mdi mdi-arrow-right menu-icon"></i></button>
                                            </a> </div>
                                    </div>
                                </div>
                            </div>
                          ...
                          do {
                              ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo date('d M Y',strtotime($row_Recordset2['date_added'])); ?>
                                                    </td>
                                                    <td>
                                                        <a
                                                            href="add_staff.php?uname=<?php echo $row_Recordset2['uname']; ?>"><i
                                                                class="mdi mdi-pencil menu-icon"></i></a>
                                                        <a
                                                            href="delete_staff.php?uname=<?php echo $row_Recordset2['uname']; ?>"><i
